...
export default function TopFooter() {    
  ...
  <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-12 py-8 md:py-10">
    <div className="flex flex-col md:flex-row justify-between items-stretch md:items-center gap-6 md:gap-8">
      ...
      <div className="w-full md:w-auto space-y-1">
        ...
        <a
          ...
          className="inline-block text-sm font-semibold text-gray-900 hover:underline pt-0.5"
        >
          Get Directions →
        </a>
      </div>
      ...
      <div className="w-full md:w-auto md:min-w-[240px]
                      bg-transparent md:bg-gray-50/50
                      md:p-5
        ...
        {isLoading ? (
          ...
          <div className="flex items-center flex-wrap gap-x-2 gap-y-1">
            ...
            <Link
              href="/ratings"
              className="ml-2 text-xs font-bold text-blue-600 hover:text-blue-700"
            >
