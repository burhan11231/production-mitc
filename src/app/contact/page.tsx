          ...
          <div className="lg:col-span-4 space-y-8">
              ...
              <div className="space-y-10">
                ...
                {settings?.workingHours && (
                  <div>
                    <div className="flex items-center gap-3 mb-5">
                      ...
                      <h3 className="text-lg font-semibold text-gray-900">Business Hours (Summer)</h3>
                    </div>
                    <div className="space-y-2 text-sm">
                      {Object.entries(settings.workingHours.summer || {}).slice(0, 3).map(([day, hours]: any) => (
                        <div key={day} className="flex justify-between items-center py-1.5 border-b border-gray-100">
                          <span className="text-gray-600 font-medium">{day}</span>
                          <span className="text-gray-900 font-semibold text-xs">{hours.open} - {hours.close}</span>
                        </div>
                      ))}
                    </div>
                  </div>
                ...
                {settings?.addressText && (
                  <div>
                    ...
                    <p className="text-gray-600 leading-relaxed text-sm">{settings.addressText}</p>
                  </div>
                )}
                    ...
                    {settings?.primaryPhone && (
                      ...
                      >
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-gray-900 font-semibold group-hover:text-blue-600 transition-colors">{settings.primaryPhone}</p>
                        </div>
                      </a>
                    )}
                  </div>
            ...
            {topSalespersons.length > 0 && (
              <div className="bg-white/60 backdrop-blur-xl rounded-3xl p-8 border border-gray-200/50 shadow-xl shadow-gray-900/5">
                <h3 className="text-xl font-bold text-gray-900 mb-6">Available Sales Team</h3>
                <div className="space-y-4">
                  {topSalespersons.map((person) => (
                    ...
                    >
                      ...
                      <svg className="w-4 h-4 text-green-600 group-hover:translate-x-1 transition-transform flex-shrink-0">
